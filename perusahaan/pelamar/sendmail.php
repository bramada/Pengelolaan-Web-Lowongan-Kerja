...
$mail->Subject = 'Lowongan kerja';

//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$mail->Body = '<h2></h2> Ada lowongan kerja baru sesuai minat anda.<hr><h3> Lamar kerja segera!</h3>';
...
if (!$mail->send()) {
    ...
    echo "Message sent!";
    message("Email penawaran lowongan berhasil dikirim.", "success");
