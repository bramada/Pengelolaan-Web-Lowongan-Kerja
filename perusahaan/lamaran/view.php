...
<div class="col-sm-6 content-body" >
	...
	<div class="col-sm-12"> 
		...
		<p style="margin-left: 15px;"><b><?php echo $appl->GELAR;?></b></p>
	</div>
	<div class="col-sm-12"> 
		<p>KTP Pelamar : </p>
...
<div class="col-sm-12 content-footer">
	...
	<div class="col-sm-12">
		<p>Feedback</p>
		<textarea class="input-group" name="REMARKS"><?php echo isset($jobreg->TANGGAPAN) ? $jobreg->TANGGAPAN : ""; ?></textarea>
	</div>
	<div class="col-sm-12  submitbutton "> 
		<button type="submit" name="submit" class="btn btn-primary"><span class="fa fa-check">&nbsp&nbspPanggil Interview</span></button>
		&nbsp;&nbsp;&nbsp;
