...
$mail->Subject = 'Konfirmasi perusahaan';

//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$mail->Body = '<h2>Akun perusahaan anda sudah kami konfirmasi.</h2> <hr><h3> Perusahaan anda sudah terdaftar di DEPNAKER. <br>Sekarang anda bisa login melalui website LokerBB untuk membuat lowongan kerja!</h3>';
