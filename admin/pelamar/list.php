				  	...
				  	<?php 
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<td align="center">
				  				...
				  				<a title="Edit" href="index.php?view=edit&id='.$result->IDPELAMAR.'" class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa">  Edit</a>
				  		     	<a title="Hapus" href="controller.php?action=delete&id='.$result->IDPELAMAR.'" class="btn btn-danger btn-xs  ">  <span class="fa  fa-trash-o fw-fa "></a></td>';
				  		// echo '<td></td>';
				  		echo '</tr>';
				  	} 
				  	?>
